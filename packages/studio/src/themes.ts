...
export const THEMES: Record<ThemeId, ThemeTokens> = {
  ...
  cinematic: {
    ...
    fonts: { heading: SERIF, body: SANS, pptxHeading: 'Georgia', pptxBody: 'Arial' },
    radius: '1.25rem',
    chartPalette: ['#f0c46b', '#dd725b', '#b88cf0', '#81c7bd', '#e8e4db'],
  },
  editorial: {
    id: 'editorial',
    name: 'Editorial',
    ...
    fonts: { heading: SERIF, body: SANS, pptxHeading: 'Georgia', pptxBody: 'Arial' },
    radius: '0.15rem',
    chartPalette: ['#bd3e2f', '#d38a37', '#3d6a7b', '#65734b', '#1d1b18'],
  },
  architectural: {
    id: 'architectural',
    name: 'Architectural',
    ...
    fonts: { heading: SANS, body: SANS, pptxHeading: 'Helvetica', pptxBody: 'Arial' },
    radius: '0',
    chartPalette: ['#173f38', '#cb542e', '#698a72', '#bb9c62', '#30332f'],
  },
  glass: {
    id: 'glass',
    name: 'Glass',
    ...
    fonts: { heading: SANS, body: SANS, pptxHeading: 'Arial', pptxBody: 'Arial' },
    radius: '1.5rem',
    chartPalette: ['#82a8ff', '#e49aff', '#7de0d2', '#ffd17a', '#ff9a9a'],
  },
};
...
export function themeCatalogue(): string {
  const notes: Record<ThemeId, string> = {
    ...
    cinematic: 'dark, dramatic, warm highlights — launches & visionary narratives',
    editorial: 'serif, tactile, magazine-like — founder stories & strategy',
    architectural: 'structured, restrained, spatial — systems & company strategy',
    glass: 'luminous dark surfaces — modern product and AI stories',
  };
